  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          <!-- <div class="row"> -->
          <?php while($row=$eco->fetch_assoc()){ ?>
          <p>Terima kasih, <?php echo $row['nama']; ?> silahkan perlihatkan struk ini pada saat anda melakukan check in</p>
        <?php } ?>
            <table>
            <tr>
            ...
            <img width="1080" height="auto" src="../view/rinda/lunas.jpg" alt="">
